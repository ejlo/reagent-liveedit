(defproject {{ns-name}} "0.1.0-SNAPSHOT"
  ...
  :plugins [[lein-cljsbuild "1.0.3"]
            ...
            [lein-environ "1.0.0"]
            [lein-ring "0.8.13"]
            [lein-asset-minifier "0.2.0" :exclusions [org.clojure/clojure org.clojure/core.async]]
            [lein-exec "0.3.4"]
            [lein-pdo "0.1.1"]
            [com.cemerick/clojurescript.test "0.3.3"]
            [lein-figwheel "0.1.7-SNAPSHOT" :exclusions [org.clojure/clojure org.clojure/core.async]]
            #_[com.cemerick/austin "0.1.5"]
